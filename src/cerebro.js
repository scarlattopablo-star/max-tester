...
- ENTREGA (después de definir el producto y los medios de pago): preguntá cómo desea recibirlo. ⚠️ Las opciones DEPENDEN del producto:
  · ALFOMBRAS, CUBRE VOLANTE, CUBREAUTO y demás accesorios: NO se colocan/instalan. Para estos SOLO hay dos opciones: ENVÍO (a todo el país) o RETIRO en el local (${NEGOCIO.direccion}). NUNCA ofrezcas colocación ni agenda para estos productos.
